...
export const PROJECTS: Project[] = [
  {
    title: 'Ежедневный AI-дайджест для команды',
    body: 'Внутренний AI-бот, который каждый день собирает и упаковывает отрасль и контекст для маркетинг-команды. Двухслойная архитектура: заголовок в Telegram + интерактивный HTML-журнал.',
...
export const TIMELINE: Role[] = [
  {
    ...
    period: '2025 → н.в.',
    body: 'Performance и unit-экономика 4 шеринговых сервисов — Яндекс Драйв, Яндекс Самокаты, Яндекс Прокат, Бери Заряд. Новые пользователи +30–90% при CAC −25–40%, 1-year ROI 140–260%, объём тестов ×7.',
    current: true,
  },
  {
    org: 'Яндекс Go',
    ...
    period: '2021–2025',
    body: 'Маркетинговый рост экосистемы Go в 8 странах, бюджеты 100М+ ₽/мес. GMV ×2.5+, антифрод −10М+ ₽/мес, агентская модель 30+ агентств.',
  },
  {
    org: 'Skyeng',
    title: 'Performance Marketing Manager · B2B',
    period: '2021',
    body: 'Привлечение B2B-лидов (ЛПР) для образовательных продуктов через ключевые digital-каналы.',
  },
  {
    org: 'Е-Лайт-Телеком · Goodline',
    title: 'Интернет-маркетолог',
    period: '2018–2020',
    body: 'Кампании для мобильного приложения, ТВ-продуктов и интернет-провайдера: продажи ТВ +44–87%, брендовые запросы ×4.',
  },
  {
    org: 'ИП · товарный бизнес',
    title: 'Основатель, интернет-маркетолог',
    period: '2017–2018',
    body: 'Товары из Китая через лендинг — сам от сайта и рекламы до логистики. Оборот ×4 за 3 месяца.',
  },
  {
    org: 'КузГТУ им. Горбачёва',
    title: 'Бакалавр — информационные системы и технологии',
    period: '2019',
